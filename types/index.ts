// Domain types for the Performance Monitor frontend.
// These model the FastAPI backend responses. Fields are kept optional where the
// backend shape may vary so the UI can render defensively.
